		...
		<Stack className="footer-container fixora-footer">
			<Box component="div" className="fixora-footer__grid">
				...
				<Box component="div" className="fixora-footer__links fixora-footer__links--popular">
					...
					<Link href="/search?q=charging+port+repair" className="fixora-footer__link">
						{t('footer.popular.chargingPort')}
					</Link>
				</Box>
				...
				<Box component="div" className="fixora-footer__discover">
					...
					<Link href="/search?location=Daejeon" className="fixora-footer__link">
						{t('footer.discover.daejeon')}
					</Link>
					<Link href="/search?location=Gwangju" className="fixora-footer__link">
						{t('footer.discover.gwangju')}
					</Link>
					<Link href="/search?location=Ulsan" className="fixora-footer__link">
						{t('footer.discover.ulsan')}
					</Link>
					<Link href="/search?location=Jeju" className="fixora-footer__link">
						{t('footer.discover.jeju')}
					</Link>
				</Box>
			</Box>
